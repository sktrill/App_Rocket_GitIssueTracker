...
function prettifyTextBodyTest (text) {
  var htmlLink =  '$1<a href="https://github.com/$2">@$2</a>'
  updatedText = text.replace(/(^|\s|>)@([a-zA-Z0-9-]{2,})/g, htmlLink);

  return {__html: updatedText};
}

module.exports = trimString;
module.exports = printLastUpdated;
module.exports = prettifyTextBodyTest;
module.exports = getTextColour;
